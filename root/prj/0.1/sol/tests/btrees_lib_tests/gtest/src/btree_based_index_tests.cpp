 ...
 */
class BTreeBasedIndexTest : public ::testing::Test
{
...
public:
     ...
     */
    BTreeBasedIndexTest() { setlocale(LC_ALL, "Russian"); }
...
}; // class BTreeBasedIndexTest

void BTreeBasedIndexTest::testIndex(std::string fileName, std::string treeFileName,
        std::string indexOutFileName, std::string linearOutFileName,
        std::wstring name, int expectedCount)
{
    ...
    indexer.create(ORDER, treeFileName);
...
void BTreeBasedIndexTest::testIndexWithDifferentParams(std::string fileName, std::string treeFileName,
        std::string indexOutFileName, std::string outputCsvFileName, std::wstring name, int expectedCount)
{
    std::cout << "File " << fileName << std::endl;
...
void BTreeBasedIndexTest::testIndexWithDifferentParamsAndCountAggregates(std::string fileName, std::string treeFileName,
        std::string indexOutFileName, std::string outputCsvFileName, std::wstring name, int expectedCount)
{
    std::cout << "File " << fileName << std::endl;
...
std::list<std::wstring> BTreeBasedIndexTest::searchLinearly(std::wstring& name, std::string fileName)
{
...
void BTreeBasedIndexTest::writeOccurrencesToFile(std::list<std::wstring>& occurrences, std::string& fileName)
{
...
double BTreeBasedIndexTest::getTimeInSecs(clock_t begin, clock_t end)
{
...
TEST_F(BTreeBasedIndexTest, IndexerTest1)
{
...
TEST_F(BTreeBasedIndexTest, IndexerTest2)
{
...
TEST_F(BTreeBasedIndexTest, IndexerWithDifferentParamsTest1)
{
    testIndexWithDifferentParams(
            "University_and_books.csv", "BTree_University_and_books.xibt",
            "Occurrences_index_University_and_books.txt", "Results_BTree_University_and_books.csv",
            L"Подбельский", 3
    );
}

TEST_F(BTreeBasedIndexTest, IndexerWithDifferentParamsTest2)
{
    testIndexWithDifferentParams(
            "Hospital_log.csv", "BTree_Hospital_log.xibt",
            "Occurrences_index_Hospital_log.txt", "Results_BTree_Hospital_log.csv",
            L"1e consult poliklinisch", 1136
    );
}

TEST_F(BTreeBasedIndexTest, IndexerWithDifferentParamsAndAggregatesTest1)
{
    testIndexWithDifferentParamsAndCountAggregates(
            "University_and_books.csv", "BTree_University_and_books.xibt",
            "Occurrences_index_University_and_books.txt", "Results_Aggr_BTree_University_and_books.csv",
            L"Подбельский", 3
    );
}
...
TEST_F(BTreeBasedIndexTest, DISABLED_IndexerWithDifferentParamsAndAggregatesTest2) // TODO: Enable.
{
    testIndexWithDifferentParamsAndCountAggregates(
            "Hospital_log.csv", "BTree_Hospital_log.xibt",
            "Occurrences_index_Hospital_log.txt", "Results_Aggr_BTree_Hospital_log.csv",
            L"1e consult poliklinisch", 1136
    );
}
